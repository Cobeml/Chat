...
public struct ChatTheme {
    ...
    public struct Colors {
        ...
        public init(
            ...
            inputLightContextBackground: Color = Color(hex: "242424"),
            inputDarkContextBackground: Color = Color(hex: "242424").opacity(0.12),
            ...
            messageMenuBackground: Color = Color(hex: "111111"),
